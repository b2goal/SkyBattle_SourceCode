...
public class ScrollRectSnap_CS : MonoBehaviour 
{
	...
	void Start()
	{
		...
		setID_Plane();
		select_plane = PlayerPrefs.GetInt(MenuScript.CURENT_PLANE);
		Vector2 newPosition = new Vector2 (-bttn[select_plane].GetComponent<RectTransform>().anchoredPosition.x, panel.anchoredPosition.y);
